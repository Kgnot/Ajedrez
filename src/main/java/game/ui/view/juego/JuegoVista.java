...
public class JuegoVista extends javax.swing.JPanel {
    ...
    private InicioLogin inicioLogin1;

    public JuegoVista(Modelo modelo) {
        this.modelo = modelo;
        initComponents();
        inicioLogin1 = new InicioLogin(getControlador());
        Login.add(inicioLogin1);
        initListener();
    ...
    private void initComponents() {
        ...
        JUGADOR.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        PanelMenuLayout.setHorizontalGroup(
            ...
            .addGroup(PanelMenuLayout.createSequentialGroup()
                .addGap(78, 78, 78)
                .addComponent(JUGADOR, javax.swing.GroupLayout.PREFERRED_SIZE, 230, javax.swing.GroupLayout.PREFERRED_SIZE)
